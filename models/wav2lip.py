...
class Wav2Lip_disc_qual(nn.Module):
	def __init__(self):
		...
		self.face_encoder_blocks = nn.ModuleList(
			[
				...
				nn.Sequential(
					NoNormConv2d(64, 128, kernel_size=5, stride=2, padding=2),  # 24,24
				...
				nn.Sequential(
					NoNormConv2d(256, 512, kernel_size=3, stride=2, padding=1),  # 6,6
					NoNormConv2d(512, 512, kernel_size=3, stride=1, padding=1),
				),
				nn.Sequential(
					NoNormConv2d(512, 512, kernel_size=3, stride=2, padding=1),  # 3,3
					NoNormConv2d(512, 512, kernel_size=3, stride=1, padding=1),
				),
				nn.Sequential(
					NoNormConv2d(512, 512, kernel_size=3, stride=1, padding=0),  # 1, 1
	...
	def perceptual_forward(self, false_face_sequences):
		...
		false_pred_loss = functional.binary_cross_entropy(
